...
has_pandoc = os.path.isfile(
    os.path.join("pypandoc", "files", "pandoc")
) or os.path.isfile(os.path.join("pypandoc", "files", "pandoc.exe"))
    ...
    if has_pandoc or is_download_pandoc:
        ...
        if is_download_pandoc:
            ...
            if pos_bdist_wheel < pos_download_pandoc:
                raise RuntimeError(
                    "'download_pandoc' needs to be before 'bdist_wheel'."
                )
